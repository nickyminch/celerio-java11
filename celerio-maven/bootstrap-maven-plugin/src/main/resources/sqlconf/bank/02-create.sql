...
COMMENT ON TABLE USER_ACCOUNT IS 'The User is a human that can connect to this web application';
COMMENT ON COLUMN USER_ACCOUNT.LOGIN IS 'The login used to login';
...
CREATE TABLE USER_ROLE (
    ...
    constraint user_role_fk_1 foreign key (user_id) references USER_ACCOUNT,
    constraint user_role_fk_2 foreign key (role_id) references USER_ROLES,
...
CREATE TABLE SAVED_SEARCH (
    ...
    constraint saved_search_fk_1 foreign key (user_id) references USER_ACCOUNT,
    primary key (id)
);
