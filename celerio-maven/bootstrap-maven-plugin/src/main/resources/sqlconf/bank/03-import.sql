...
INSERT INTO USER_ACCOUNT (id, login, password, email, is_enabled, version) VALUES (-1, 'admin', 'admin', 'admin@example.com', true, 1);

INSERT INTO USER_ROLES (id, role_name) VALUES (-1, 'ROLE_ADMIN');
INSERT INTO USER_ROLES (id, role_name) VALUES (-2, 'ROLE_USER');
INSERT INTO USER_ROLES (id, role_name) VALUES (-3, 'ROLE_MONITORING');
