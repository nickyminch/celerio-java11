...
import com.jaxio.celerio.configuration.entity.FullTextField;
...
public class SearchAttribute extends AbstractAttributeSpi {
    ...
    public String getFullTextFieldAnnotation() {
        FullTextField field = attribute.getColumnConfig().getFullTextField();
        if (field == null) {
            return "";
        }
...
//        }
        ...
        if (analyze != null && analyze != FullTextFieldDefaults.analyze) {
        	addImport("org.hibernate.search.mapper.pojo.mapping.definition.annotation.FullTextField");
        	attributes.add("analyze=\"" + analyze.name()+"\"");
        }
        
        Boolean projectable = field.getProjectable();
        if(projectable!=null&&projectable) {
        	addImport("org.hibernate.search.engine.backend.types.Projectable");
        	attributes.add("projectable=\"Projectable.YES\"");
        }
        // analyzer
//        String analyzer = field.getAnalyzer();
//        if (analyzer != null) {
//        	addImport("org.hibernate.search.mapper.pojo.mapping.definition.annotation.FullTextField");
//        	attributes.add("analyzer = \"" + analyzer + "\"");
//        } else {
//            addImport("org.hibernate.search.annotations.Analyzer");
//            attributes.add("analyzer = analyzer=\"custom\"");
//        }
//        // norms
...
//        }
        ...
        addImport("org.hibernate.search.mapper.pojo.mapping.definition.annotation.FullTextField");
        return attributes.bindAttributesTo("@FullTextField");
    }
